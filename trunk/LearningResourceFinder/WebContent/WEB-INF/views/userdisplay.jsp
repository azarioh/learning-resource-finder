		...
		<div class="panel panel-default">
		  	<div class="panel-body">
				<ul>
					...
					<li><label>Points de contribution :</label><a href="/rights?username=${user.userName}"> ${current.user.userProgressPoints} sur ${current.user.accountLevel.levelProgressPoints} pour arriver au niveau suivant.</a></li>
