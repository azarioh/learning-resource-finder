...
<body>
	<div class="container">
        ...
        Affichez d’abord le site de la ressource (jeu, exercice, vidéo, etc.) concernée. Ensuite appuyez sur la touche « Imp Ecran » 
		...
		cliquez sur le signe « + » et choisissez l’option <br/>« Depuis le presse papier ». Ensuite, à l'aide de votre clavier, appuyez simultanément 
		sur les touches Ctrl et V. Votre capture d’écran s’affiche à l’écran. Si vous le désirez, vous avez	alors la possibilité de sélectionner une 
		zone bien précise de cette image à l’aide de votre souris. Faites glisser le pointeur sur la partie de l’image à conserver afin de créer le 
		rectangle de sélection. Pour déplacer le rectangle de sélection, placez le pointeur à l’intérieur du cadre de sélection et faites-le glisser. 
		Sélectionnez une zone pour n’avoir que l’essentiel, de quoi permettre à un élève ou un professeur de « se faire une idée » en voyant une 
		miniature de cette image.</p><br/>
