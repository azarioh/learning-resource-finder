...
<div id="progressbar">
	<c:if test="${current.user != null}">
		<div style="font-size:10px; position:absolute; top:37px; right:16px" 
		     data-toggle="tooltip" title="${current.user.userProgressPoints} points de contribution (sur ${current.user.accountLevel.levelProgressPoints} pour arriver au niveau suivant).">
