		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="col-md-12">
					...
					<a ${canAddProblem ? "href='#modalProblemReport' data-toggle='modal'" : "class='noAddProblemPop' style=cursor:pointer"}>Signaler un probl�me.</a>
					<a data-placement="top" data-toggle="tooltip" data-original-title='Signaler un probl�me...'
